...
/**
  ...
  *  - Bank ID                : 3
  *  - Bank Register Address  : 0x68000000
  *  - Bank Memory Address    : 0x68000002
  *  - Data Size              : 16 bits
  */
extern "C" {
    /**
     ...
     */
#define FMC_BANK3_REG ((uint16_t *) 0x68000000)
#define FMC_BANK3_MEM ((uint16_t *) 0x68000002)

    /**
      * @brief  Writes register address.
      * @param  Reg: Register to be written
      */
    __STATIC_INLINE void FMC_BANK3_WriteReg(uint8_t Reg)
    {
    ...
    /**
      ...
      */
    __STATIC_INLINE void FMC_BANK3_WriteData(uint16_t Data)
    {
        /* Write 16-bits Reg */
        *FMC_BANK3_MEM = Data;
        __DSB();
    ...
    /**
      ...
      * @retval Read value
      */
    __STATIC_INLINE uint16_t FMC_BANK3_ReadData(void)
    {
        return *FMC_BANK3_MEM;
    }
